...
class RekapUangMakanTransportPerBagianDeptController extends Controller
{
    /**
     * Display form untuk cetak rekap uang makan & transport per bagian/dept
     */
    public function index()
    {
        ...
        return view('laporan.rekap-uang-makan-transport-per-bagian-dept.index', compact('divisis', 'defaultPeriode'));
    }

    /**
     * Preview/Print rekap uang makan & transport per bagian/dept berdasarkan filter
     */
    public function preview(Request $request)
    {
        ...
        if ($closings->isEmpty()) {
            return redirect()->route('rekap-uang-makan-transport-per-bagian-dept.index')
        ...
        return view('laporan.rekap-uang-makan-transport-per-bagian-dept.preview', compact(
            'groupedData',
            'grandTotal',
            'tanggalAwal',
            'tanggalAkhir',
