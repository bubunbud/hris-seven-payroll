...
class RekapitulasiAbsensiController extends Controller
{
     ...
     * Update: Mempertimbangkan tukar hari kerja
     */
    ...
    {
        // 1. Jumlah Hari Kerja Normal Kalender (exclude Sabtu/Minggu & hari libur, dengan mempertimbangkan tukar hari kerja)
        $holidayDates = $this->getHariLiburWithTukar($startDate, $endDate, $nik);
        
        $jumlahHariKerja = $this->calculateHariKerja($startDate, $endDate, $nik);
        ...
        // Filter hanya hari kerja normal (exclude weekend & hari libur, dengan mempertimbangkan tukar hari kerja)
        $hadir = 0;
        foreach ($tanggalHadirList as $tanggalStr) {
            // Gunakan helper function untuk cek apakah hari kerja normal
        ...
        // 6. Terlambat (T) - jam masuk > jam shift masuk (hanya hari kerja normal, dengan mempertimbangkan tukar hari kerja)
        $terlambat = 0;
        ...
        // 7. K8 = Jam Kerja Kurang dari 8 jam (hanya hari kerja normal, dengan mempertimbangkan tukar hari kerja)
        $kurang8Jam = 0;
        foreach ($absenList as $ab) {
            $tanggalStr = $ab->dtTanggal instanceof Carbon 
                ? $ab->dtTanggal->format('Y-m-d') 
