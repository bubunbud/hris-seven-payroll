...
class Closing extends Model
{
    ...
    protected $fillable = [
        ...
        'decPremi',
        'decJamLemburKerja1', 'decJamLemburKerja2', 'decJamLemburKerja3', 'decJamLemburKerja4',
        'decLemburKerja1', 'decLemburKerja2', 'decLemburKerja3', 'decLemburKerja4',
        'decJamLemburLibur2', 'decJamLemburLibur3',
        'decLembur2', 'decLembur3',
        'decJamLemburKerja', 'decJamLemburLibur',
        'decTotallembur1', 'decTotallembur2', 'decTotallembur3', 'decTotallembur4',
