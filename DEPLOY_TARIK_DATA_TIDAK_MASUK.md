# 📋 Panduan Deployment: Fitur Tarik Data Tidak Masuk

**Tanggal:** 8 Desember 2025  
**Fitur:** Tarik Data Tidak Masuk dari Server Remote  
**Lokasi Menu:** Settings → Tarik Data Tidak Masuk
...
4. Pastikan menu **"Tarik Data Tidak Masuk"** muncul di submenu Settings (di bawah "Tarik Data Izin")
5. Klik menu **"Tarik Data Tidak Masuk"**
...
4. **Composite Key**: Tabel `t_tidak_masuk` menggunakan composite key: `vcNik + vcKodeAbsen + dtTanggalMulai + dtTanggalSelesai`
5. **Filter Tanggal**: Filter berdasarkan `dtTanggalMulai` (bukan `dtTanggal`)
...
**Selamat! Fitur Tarik Data Tidak Masuk sudah siap digunakan.** 🎉
