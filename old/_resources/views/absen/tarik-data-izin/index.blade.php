...
@section('title', 'Tarik Data Izin - HRIS Seven Payroll')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-download me-2"></i>Tarik Data Izin
                </h2>
            </div>
                    ...
                    <form id="tarikDataForm">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="server_table" name="server_table" value="t_izin" required placeholder="t_izin">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_vcKodeIzin" value="vcKodeIzin" checked>
                                        <label class="form-check-label" for="field_vcKodeIzin">vcKodeIzin</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_vcTipeIzin" value="vcTipeIzin">
                                        <label class="form-check-label" for="field_vcTipeIzin">vcTipeIzin</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtDari" value="dtDari" checked>
                                        <label class="form-check-label" for="field_dtDari">dtDari</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtSampai" value="dtSampai" checked>
                                        <label class="form-check-label" for="field_dtSampai">dtSampai</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                            ...
                            <small class="text-muted">Pilih minimal 1 field. Field yang dipilih akan di-insert ke tabel lokal. Jika vcCounter tidak dipilih, akan di-generate otomatis.</small>
                        </div>
...
<script>
    document.getElementById('tarikDataForm').addEventListener('submit', function(e) {
        ...
        // AJAX request
        fetch('{{ route("tarik-data-izin.pull") }}', {
                method: 'POST',
                headers: {
                    ...
                    if (data.success) {
                        ...
                        if (data.data.error_details && data.data.error_details.length > 0) {
                            ...
                            data.data.error_details.forEach(error => {
                                detailsHtml += '<li class="text-danger small">vcCounter: ' + error.vcCounter + ', NIK: ' + error.nik + ', Tanggal: ' + error.tanggal + ' - ' + error.error + '</li>';
                            });
                            detailsHtml += '</ul></div>';
                        }
