...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <form method="GET" action="{{ route('departemen.index') }}" id="filterForm">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-secondary w-100" onclick="window.location.href='{{ route('departemen.index') }}'">
                            ...
                            <div class="col-md-6">
                                <div class="text-muted small">
                                    ...
                                    Filter berdasarkan prefix kode departemen sesuai divisi
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Pilih divisi untuk generate kode departemen otomatis</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="kode_dept" class="form-label">Kode Departemen <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="kode_dept" name="vcKodeDept" required maxlength="10" readonly>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (addModal) {
            addModal.addEventListener('show.bs.modal', function() {
                ...
                const kodeDeptInput = document.getElementById('kode_dept');
                if (divisiSelect) divisiSelect.value = '';
                if (kodeDeptInput) {
                    kodeDeptInput.value = '';
                    kodeDeptInput.readOnly = true;
                }
            });
        }

        // Auto-generate kode departemen saat pilih divisi
        const divisiSelect = document.getElementById('divisi_select');
        const kodeDeptInput = document.getElementById('kode_dept');
        
        if (divisiSelect && kodeDeptInput) {
            divisiSelect.addEventListener('change', function() {
                ...
                // Fetch kode departemen otomatis dari server
                fetch('/departemen/generate-kode', {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                            'Content-Type': 'application/json',
                    ...
                    .then(data => {
                        if (data.success) {
                            kodeDeptInput.value = data.kodeDept;
                            kodeDeptInput.readOnly = true; // Set readonly setelah di-generate
                        } else {
                            alert('Gagal generate kode departemen: ' + (data.message || 'Unknown error'));
                            kodeDeptInput.value = '';
                            kodeDeptInput.readOnly = true;
                        }
                    })
                    .catch(error => {
                        console.error('Error generating kode departemen:', error);
                        alert('Terjadi kesalahan saat generate kode departemen');
                        kodeDeptInput.value = '';
                        kodeDeptInput.readOnly = true;
                    });
            });
                ...
                .then(async response => {
                    ...
                    if (contentType && contentType.includes('application/json')) {
                        ...
                        try {
                            ...
                            if (response.ok) {
                                result = { success: true, message: 'Departemen berhasil ditambahkan.' };
                            } else {
