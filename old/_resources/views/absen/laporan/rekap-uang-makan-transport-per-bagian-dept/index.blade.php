...
@section('title', 'Laporan Uang Makan & Transport Per Bagian / Departemen')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-file-alt me-2"></i>Laporan Uang Makan & Transport Per Bagian / Departemen
                </h2>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-filter me-2"></i>Filter Laporan Uang Makan & Transport Per Bagian / Departemen</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('rekap-uang-makan-transport-per-bagian-dept.preview') }}" id="formRekapUangMakanTransportPerBagianDept">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Validasi form
        document.getElementById('formRekapUangMakanTransportPerBagianDept').addEventListener('submit', function(e) {
