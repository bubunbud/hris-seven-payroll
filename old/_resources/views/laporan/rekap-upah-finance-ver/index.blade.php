...
@section('title', 'Rekap Upah Finance Ver')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-file-alt me-2"></i>Rekap Upah Finance Ver
                </h2>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-filter me-2"></i>Filter Rekap Upah Finance Ver</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('rekap-upah-finance-ver.preview') }}" id="formRekapUpahFinanceVer">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Contoh: 1 Januari 2026 atau 15 Januari 2026</small>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Validasi form
        document.getElementById('formRekapUpahFinanceVer').addEventListener('submit', function(e) {
