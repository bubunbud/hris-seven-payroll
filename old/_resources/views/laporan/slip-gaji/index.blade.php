    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-file-invoice me-2"></i>Cetak Slip Gaji
                </h2>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-filter me-2"></i>Filter Slip Gaji</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('slip-gaji.preview') }}" id="formSlipGaji">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="nik_dari" name="nik_dari" 
                                           placeholder="Dari NIK" maxlength="8">
                                    <span class="input-group-text">to</span>
                                    <input type="text" class="form-control" id="nik_sampai" name="nik_sampai" 
                                           placeholder="Sampai NIK" maxlength="8">
                                </div>
                                <small class="form-text text-muted">Kosongkan untuk semua karyawan</small>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Validasi form
    document.getElementById('formSlipGaji').addEventListener('submit', function(e) {
