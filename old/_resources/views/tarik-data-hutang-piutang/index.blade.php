...
@section('title', 'Tarik Data Hutang Piutang - HRIS Seven Payroll')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-download me-2"></i>Tarik Data Hutang Piutang
                </h2>
            </div>
                    ...
                    <form id="tarikDataForm">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="server_table" name="server_table" value="t_hutang_piutang" required placeholder="t_hutang_piutang">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-2">
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtTanggalAwal" value="dtTanggalAwal" checked>
                                        <label class="form-check-label" for="field_dtTanggalAwal">dtTanggalAwal</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtTanggalAkhir" value="dtTanggalAkhir" checked>
                                        <label class="form-check-label" for="field_dtTanggalAkhir">dtTanggalAkhir</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_vcJenis" value="vcJenis" checked>
                                        <label class="form-check-label" for="field_vcJenis">vcJenis</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_decAmount" value="decAmount" checked>
                                        <label class="form-check-label" for="field_decAmount">decAmount</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_vcPeriodik" value="vcPeriodik">
                                        <label class="form-check-label" for="field_vcPeriodik">vcPeriodik</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_vcFlag" value="vcFlag">
                                        <label class="form-check-label" for="field_vcFlag">vcFlag</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                            ...
                            <small class="text-muted">Pilih minimal 1 field. Field yang dipilih akan di-insert ke tabel lokal. Field dtTanggalAwal, dtTanggalAkhir, vcNik, dan vcJenis wajib untuk composite key.</small>
                        </div>
...
<script>
    document.getElementById('tarikDataForm').addEventListener('submit', function(e) {
        ...
        // AJAX request
        fetch('{{ route("tarik-data-hutang-piutang.pull") }}', {
                method: 'POST',
                headers: {
                    ...
                    if (data.success) {
                        ...
                        if (data.data.error_details && data.data.error_details.length > 0) {
                            ...
                            data.data.error_details.forEach(error => {
                                detailsHtml += '<li class="text-danger small">NIK: ' + error.nik + ', Jenis: ' + error.jenis + ', Tanggal Awal: ' + error.tanggal_awal + ', Tanggal Akhir: ' + error.tanggal_akhir + ' - ' + error.error + '</li>';
                            });
                            detailsHtml += '</ul></div>';
                        }
