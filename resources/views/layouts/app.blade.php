                ...
                <li class="menu-item">
                    ...
                    <div id="absensi" class="collapse">
                        <ul class="submenu py-2 px-3">
                            ...
                            @endif
                            @if($sidebarUser->hasPermission('view-absensi') || $sidebarUser->hasPermission('view-perjalanan-dinas'))
                            <li><a href="{{ route('perjalanan-dinas.index') }}">Form Perjalanan Dinas</a></li>
                            @endif
                            @if($sidebarUser->hasPermission('view-absensi') || $sidebarUser->hasPermission('view-perjalanan-dinas') || $sidebarUser->hasPermission('view-biaya-perjalanan-dinas'))
                            <li><a href="{{ route('biaya-perjalanan-dinas.index') }}">Form Biaya Perjalanan Dinas</a></li>
                            @endif
                ...
                <li class="menu-item">
                    ...
                    <div id="proses" class="collapse">
                        <ul class="submenu py-2 px-3">
                            ...
                            @endif
                            @if($sidebarUser->hasPermission('view-proses-gaji') || $sidebarUser->hasPermission('view-periode-thr'))
                            <li><a href="{{ route('periode-thr.index') }}">Periode Closing THR</a></li>
                            @endif
                            ...
                            @endif
                            @if($sidebarUser->hasPermission('view-proses-gaji') || $sidebarUser->hasPermission('view-closing-thr'))
                            <li><a href="{{ route('closing-thr.index') }}">Closing THR</a></li>
                            @endif
                            @if($sidebarUser->hasPermission('view-proses-gaji') || $sidebarUser->hasPermission('view-list-thr'))
                            <li><a href="{{ route('list-thr.index') }}">List THR</a></li>
                            @endif
                ...
                <li class="menu-item">
                    ...
                    <div id="laporan" class="collapse">
                        <ul class="submenu py-2 px-3">
                            ...
                            @endif
                            @if($sidebarUser->hasPermission('view-laporan') || $sidebarUser->hasPermission('view-laporan-thr'))
                            <li><a href="{{ route('slip-thr.index') }}">Slip THR</a></li>
                            @endif
                            ...
                            @endif
                            @if($sidebarUser->hasPermission('view-laporan') || $sidebarUser->hasPermission('view-laporan-thr'))
                            <li><a href="{{ route('laporan-thr.index') }}">Rekap THR Operator</a></li>
                            @endif
                            @if($sidebarUser->hasPermission('view-laporan') || $sidebarUser->hasPermission('view-laporan-thr'))
                            <li><a href="{{ route('laporan-thr-staff.index') }}">Rekap THR Staff</a></li>
                            @endif
                            @if($sidebarUser->hasPermission('view-laporan') || $sidebarUser->hasPermission('view-laporan-thr'))
                            <li><a href="{{ route('rekap-bank-thr.index') }}">Rekap Bank THR</a></li>
                            @endif
                            ...
                            @endif
                            @if($sidebarUser->hasPermission('view-absensi') || $sidebarUser->hasPermission('view-statistik-absensi'))
                            <li><a href="{{ route('rekap-keterlambatan.index') }}">Rekap Absensi Keterlambatan</a></li>
                            @endif
