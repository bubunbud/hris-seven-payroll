...
@section('title', 'Preview Laporan Uang Makan & Transport Per Bagian / Departemen')
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0 no-print">
                    <i class="fas fa-file-alt me-2"></i>Preview Laporan Uang Makan & Transport Per Bagian / Departemen
                </h2>
                <div>
    ...
    <div class="print-header">
        <h3>LAPORAN UANG MAKAN & TRANSPORT KARYAWAN</h3>
        <h4>
    ...
    <div class="report-content">
        ...
        <table class="rekap-table">
            <thead>
                <tr>
                    <th rowspan="2" style="width: 15%;">Group Departemen / Bagian</th>
                    ...
                    <th rowspan="2" style="width: 8%;">Jumlah Penerimaan UM+UT</th>
            ...
            <tbody>
                ...
                <tr class="bold" style="background-color: #e0e0e0;">
                    <td colspan="18"><strong>Dept. {{ $departemen['nama'] }}</strong></td>
                </tr>
                ...
                <tr class="bold" style="background-color: #f0f0f0;">
                    <td><strong>TOTAL {{ $departemen['nama'] }}</strong></td>
        ...
        <div class="report-footer">
            ...
            <div style="margin-top: 30px; display: flex; justify-content: space-around; align-items: center;">
                ...
                <div class="signature-block">
                    <p style="margin: 0; text-align: center;"><strong>Menyetujui,</strong></p>
                </div>
            </div>
