...
@section('title', 'Tarik Data Absensi - HRIS Seven Payroll')
                    ...
                    <form id="tarikDataForm">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="server_table" name="server_table" value="t_absen" required placeholder="t_absen">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="row g-2">
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtTanggal" value="dtTanggal" checked>
                                        <label class="form-check-label" for="field_dtTanggal">dtTanggal</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtJamMasuk" value="dtJamMasuk" checked>
                                        <label class="form-check-label" for="field_dtJamMasuk">dtJamMasuk</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtJamKeluar" value="dtJamKeluar" checked>
                                        <label class="form-check-label" for="field_dtJamKeluar">dtJamKeluar</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtJamMasukLembur" value="dtJamMasukLembur">
                                        <label class="form-check-label" for="field_dtJamMasukLembur">dtJamMasukLembur</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_dtJamKeluarLembur" value="dtJamKeluarLembur">
                                        <label class="form-check-label" for="field_dtJamKeluarLembur">dtJamKeluarLembur</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_vcCounter" value="vcCounter">
                                        <label class="form-check-label" for="field_vcCounter">vcCounter</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input field-checkbox" type="checkbox" id="field_intDurasiIstirahat" value="intDurasiIstirahat">
                                        <label class="form-check-label" for="field_intDurasiIstirahat">intDurasiIstirahat</label>
                                    </div>
                                </div>
                            </div>
                            <small class="text-muted">Pilih minimal 1 field. Field yang dipilih akan di-insert ke tabel lokal.</small>
                        </div>
...
<script>
    document.getElementById('tarikDataForm').addEventListener('submit', function(e) {
        ...
        // AJAX request
        fetch('{{ route("tarik-data-absensi.pull") }}', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                setTimeout(() => {
                    ...
                    if (data.success) {
                        ...
                        detailsHtml += '<li>Data di-update (jam kosong diisi): ' + data.data.updated + ' record</li>';
                        detailsHtml += '<li>Data di-skip (sudah lengkap): ' + data.data.skipped + ' record</li>';
                        ...
                        if (data.data.error_details && data.data.error_details.length > 0) {
                            ...
                            data.data.error_details.forEach(error => {
                                detailsHtml += '<li class="text-danger small">NIK: ' + error.nik + ', Tanggal: ' + error.tanggal + ' - ' + error.error + '</li>';
                            });
                            detailsHtml += '</ul></div>';
                        }
