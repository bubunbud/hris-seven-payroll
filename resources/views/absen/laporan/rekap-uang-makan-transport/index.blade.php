...
@section('title', 'Rekap Uang Makan & Transport')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">
                    <i class="fas fa-file-alt me-2"></i>Rekap Uang Makan & Transport
                </h2>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-filter me-2"></i>Filter Rekap Uang Makan & Transport</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('rekap-uang-makan-transport.preview') }}" id="formRekapUangMakanTransport">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Validasi form
        document.getElementById('formRekapUangMakanTransport').addEventListener('submit', function(e) {
