                ...
                <div class="card slip-gaji-card">
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-6 text-end">
                                {{ $closing->intMakan }} x {{ number_format($closing->decVarMakan ?? 0, 0, ',', '.') }} = Rp. {{ number_format($closing->decUangMakan, 2, ',', '.') }}
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-6 text-end">
                                {{ $closing->intTransport }} x {{ number_format($closing->decVarTransport ?? 0, 0, ',', '.') }} = Rp. {{ number_format($closing->decTransport, 2, ',', '.') }}
                            </div>
                        </div>
